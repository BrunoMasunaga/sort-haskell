...
/* package sorths-0.1.0.0 */
#ifndef VERSION_sorths
#define VERSION_sorths "0.1.0.0"
#endif /* VERSION_sorths */
#ifndef MIN_VERSION_sorths
#define MIN_VERSION_sorths(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_sorths */
